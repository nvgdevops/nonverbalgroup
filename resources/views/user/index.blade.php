...
.padding-vertical {
                  ...
                  <div class="w-tab-content">
                    <div data-w-tab="Tab 1" class="w-tab-pane w--tab-active">
                      <div class="login-form w-form">
                        <form id="wf-form-Login-Form" name="wf-form-Login-Form" data-name="Login Form" method="post" class="form" data-wf-page-id="651f058e03afa94d69f85ce0" data-wf-element-id="8e3a1d49-54a7-b113-3938-89b78948bf1c">
                          <div class="padding-section-small">
                            <div class="form-wrapper">
                              ...
                              <div class="field-wrap hide"><input type="text" class="input-text hide w-input" maxlength="256" name="last-name" data-name="Last Name" placeholder="" id="last-name" w-el="signin_password" required="">
                                <div class="floating-label">Password</div>
                              </div><input type="submit" value="Log in with Email" data-wait="Please Wait..." fs-mirrorclick-element="target-99" w-el="signin_submit" class="button hide w-button">
                              <a fs-mirrorclick-element="trigger-99" data-w-id="8b9d3c23-5252-d5cd-7c0c-3eba90a219bd" href="#" class="button anim w-inline-block">
                    ...
                    <div data-w-tab="Tab 2" class="w-tab-pane">
                      <div class="login-form w-form">
                        <form id="wf-form-Signup-Form" name="wf-form-Signup-Form" data-name="Signup Form" method="post" class="form" data-wf-page-id="651f058e03afa94d69f85ce0" data-wf-element-id="d41f369d-fab0-b855-33dd-bd5b6167c7cf">
                          <div class="padding-section-small">
                            <div class="form-wrapper">
                              <div class="field-wrap"><input type="text" class="input-text w-input" maxlength="256" name="email-2" data-name="Email 2" placeholder="john@doe.com" id="email-2" w-el="signup_name" required="">
                                <div class="floating-label">Name</div>
                              </div>
                              <div class="field-wrap"><input type="email" class="input-text w-input" maxlength="256" name="email-2" data-name="Email 2" placeholder="john@doe.com" id="email-2" w-el="signup_email" required="">
                                <div class="floating-label">Email address</div>
                              </div>
                              <div class="field-wrap hide"><input type="password" class="input-text w-input" maxlength="256" name="last-name-2" data-name="Last Name 2" placeholder="" id="last-name-2" w-el="signup_password" required="">
                                <div class="floating-label">Password</div>
                              </div><label id="w-node-d41f369d-fab0-b855-33dd-bd5b6167c7da-69f85ce0" class="w-checkbox c-checkbox-field hide">
                              ...
                              </label><input type="submit" value="Start now" data-wait="Please Wait..." fs-mirrorclick-element="target-98" w-el="signup_submit" class="button hide w-button">
                              <a fs-mirrorclick-element="trigger-98" data-w-id="80154231-8c1e-3673-d59f-8bb793f4ee4a" href="#" class="button anim w-inline-block">
                                <div class="content-block">
                                  <div style="width:0px" class="block-lottie">
  ...
  <script src="/assets/js/training-nvg-platform.js" type="text/javascript"></script>
</body>
</html>