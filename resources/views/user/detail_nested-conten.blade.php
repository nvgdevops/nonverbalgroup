...
<html data-wf-page="655b434272e0596d7e6126d9" data-wf-site="655b434272e0596d7e6126bc">
<head>
  <meta charset="utf-8">
  ...
  <link href="/assets/images/webclip.png" rel="apple-touch-icon"><!--  [Attributes by Finsweet] CMS Nest  -->
...
<body>
  ...
  <div w-el="sub_content_page_wrapper" style="opacity:0" class="page-wrapper">
    <div class="navigation">
      <div class="nav">
        <div class="padding-global is-desktop nav">
          <div class="navigation-wrapper">
            ...
            <div class="video_player-content grid">
              <div class="div-prev-next-buttons">
                <?php if($prev_slug != '') { ?>
                  <a href="<?php echo URL("/").'/detail-nested-conten/'.$prev_slug; ?>" class=" ">
                    <div fs-cmsprevnext-element="previous" class="wrapper-cms-arrow prev"></div>
                    <div fs-cmsprevnext-element="previous-empty" class="wrapper-cms-arrow prev empty"></div>
                  </a>
                <?php } ?>
              </div>
              <div class="row-header text-color-white">
                <div w-el="subcontent_number" id="w-node-_93fd4a93-b110-1ef5-82bd-9b198c6b26cd-69f85ce9" class="label-size-regular title"></div>
                <h4 w-el="subcontent_title" id="w-node-_93fd4a93-b110-1ef5-82bd-9b198c6b26cf-69f85ce9" class="heading-style-h4 uppercase">{{$lesson->lesson_name}}</h4>
              </div>
              <div class="div-prev-next-buttons">
                  <?php if($next_slug != '') { ?>
                  <a href="<?php echo URL("/").'/detail-nested-conten/'.$next_slug; ?>" class=" ">
                    <div fs-cmsprevnext-element="next" class="wrapper-cms-arrow next"></div>
                    <div fs-cmsprevnext-element="next-empty" class="wrapper-cms-arrow empty next"></div>
                  </a>
              <?php } ?>
              </div>
            </div>
              ...
              <div class="w-dyn-list">
                <div role="list" class="w-dyn-items">
                  <div role="listitem" class="w-dyn-item">
                    <a href="<?php echo url()->previous() ?>" class="button-back w-inline-block">
      ...
      <div class="navside_bar-copy">
        <div class="navside_bar">
          <div class="sidebar-wrapper">
            ...
            <a w-el="logout_btn" href="#" class="sidebar-link logout is-last w-inline-block">
              <div>Logout</div>
            </a>
          </div>
        </div>
...
.padding-vertical {
  ...
  padding-left: 0rem !important;
    ...
    <div class="main-inner">
      <main class="main-wrapper">
        ...
        <div class="section_video-hero">
          <div class="padding-global mobile-version">
            <div class="container-large">
              <div class="video-wrapper">
                <div class="bg-video pointer-events-on w-embed w-script">
                 
                 <script src="https://fast.wistia.com/embed/medias/{{$lesson->wistia_video_id}}.jsonp" async=""></script>
                  <script src="https://fast.wistia.com/assets/external/E-v1.js" async=""></script>
                  <div class="wistia_embed wistia_async_{{$lesson->wistia_video_id}} wistia_embed_initialized" style="height:100%;width:100%">&nbsp;</div>
          ...
          <div class="padding-global">
            <div class="container-large">
              <div class="padding-section-medium">
                <div class="dual-wrapper secondary">
                     @if($lesson->structured_transcript)
                  <div id="w-node-_93fd4a93-b110-1ef5-82bd-9b198c6b26e6-7e6126d9" class="course_container align-top">
                    <div id="w-node-_93fd4a93-b110-1ef5-82bd-9b198c6b26e7-7e6126d9" class="section-header align-top">
                      <h2 w-el="subcontent_page_heading" class="heading-style-h2">Transcript</h2>
                    </div>
                    <div w-el="subcontent_page_richtext" id="w-node-_93fd4a93-b110-1ef5-82bd-9b198c6b26ea-7e6126d9" class="text-rich-text w-richtext">
                        <?php echo $lesson->structured_transcript; ?>
                    </div>
                  </div>
                  @endif
                  <div id="w-node-_93fd4a93-b110-1ef5-82bd-9b198c6b26f1-7e6126d9" class="course_container">
                    @if($lesson->pdf)
                    <a href="{{$lesson->pdf}}" class="item-download-wrapper w-inline-block" target="_blank">
                      <div class="item-download">
                        <div id="w-node-_93fd4a93-b110-1ef5-82bd-9b198c6b26f4-69f85ce9" class="label-size-regular">DOWNLOAD PDF</div>
                        <div id="w-node-_93fd4a93-b110-1ef5-82bd-9b198c6b26f6-69f85ce9" class="icon-1x1-small w-embed"><svg aria-hidden="true" fill="currentColor" role="img" viewbox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div class="content-key-points">
                      ...
                      <div>
                        <h2 class="heading-style-h2">Key Points in This Video</h2> 
                      </div>
                      <div class="key-point-inner">
                        <div w-el="subcontent_page_keypoints" class="text-rich-text w-richtext">
                         <?php echo $lesson->key_points; ?>
                        </div>
                      </div>
                      @endif
                    </div>
        ...
        <div>
          <div class="w-dyn-list">
            <div fs-cmscombine-element="list" fs-cmsprevnext-element="list" role="list" class="w-dyn-items">
              <div role="listitem" class="w-dyn-item">
                <a fs-cmsprevnext-element="next" href="#" class="next-btn w-inline-block"></a>
              </div>
            </div>
          ...
          <div class="hide w-form">
            <form id="email-form" name="email-form" data-name="Email Form" method="get" data-wf-page-id="655b434272e0596d7e6126d9" data-wf-element-id="c7d966f0-6ad7-e6cb-c6a0-7482eff81922"><input type="text" class="w-input" maxlength="256" name="User-Email" data-name="User Email" placeholder="Example Text" id="User-Email" w-el="input_quiz_author_name" required=""></form>
       ...
       <div id="start" class="section_course-list hide">
          <div class="padding-global">
            <div class="container-large">
              <div class="padding-section-medium">
                <div>
                  <div id="w-node-cdfeec6a-7fff-7f3c-c124-f73a49d8258c-69f85ce9" class="course_container max-width-medium container">
                    <a href="{{$lesson->pdf}}" class="item-download-wrapper secondary w-inline-block" target="_blank">
                      <div class="item-download">
                        <div id="w-node-cdfeec6a-7fff-7f3c-c124-f73a49d8258f-69f85ce9" class="label-size-regular text-size-medium text-spacing">download workshop pdf</div>
                        <div id="w-node-cdfeec6a-7fff-7f3c-c124-f73a49d82591-69f85ce9" class="icon-16px w-embed"><svg width="100%" height="100%" viewbox="0 0 17 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <g id="np_download_5680635_000000 2" clip-path="url(#clip0_1427_4184)">
                              <g id="Group">
                                <path id="Vector" d="M1.88528 10.4979V13.7854H15.1147V10.4979H16.575V15.1591H0.424952V10.4979H1.88528Z" fill="white"></path>
                                <path id="Vector_2" d="M2.83554 7.75187L3.86749 6.78L7.77018 10.4531V0.840637H9.22979V10.4531L13.1325 6.78L14.1644 7.75187L8.50003 13.0831L2.83554 7.75187Z" fill="currentcolor"></path>
                              </g>
                            </g>
                            <defs>
                              <clippath id="clip0_1427_4184">
                                <rect width="17" height="16" fill="currentcolor" transform="matrix(-1 0 0 1 17 0)"></rect>
                              </clippath>
                            </defs>
                          </svg></div>
                      </div>
                    </a>
                    <div id="w-node-_2b2b2472-2243-235c-6f60-4440e2373c71-69f85ce9" class="line no-margin"></div>
                    <div class="content-key-points">
                      <div>
                        <h2 class="heading-style-h2 title-medium">Notes and Personal Insights</h2>
                        <div class="divider _4px"></div>
                        <div class="label-size-regular text-weight-light size-medium">What are you getting from this video?</div>
                      </div>
                      <div id="w-node-eb7315e4-7669-d81e-9ea2-c808fb4fcc8c-69f85ce9" class="w-form">
                        <form id="email-form-2" name="email-form-2" data-name="Email Form 2" method="get" data-wf-page-id="651f058e03afa94d69f85ce9" data-wf-element-id="eb7315e4-7669-d81e-9ea2-c808fb4fcc8d">
                          <div class="key-point-inner"><textarea placeholder="Write a message here..." maxlength="5000" id="field" name="field" data-name="Field" class="input-field-area w-input"></textarea></div><input type="submit" data-wait="Please wait..." class="button full-width uppercase border-radius text-spacing w-button" value="Submit">
                        </form>
                        <div class="w-form-done">
                          <div>Thank you! Your submission has been received!</div>
                        </div>
                ...
                <div class="dual-wrapper third">
                  <div id="w-node-cdfeec6a-7fff-7f3c-c124-f73a49d825ab-69f85ce9" class="course_container align-top">
                    <div id="w-node-cdfeec6a-7fff-7f3c-c124-f73a49d825ac-69f85ce9" class="section-header align-top">
                      <h2 w-el="subcontent_page_heading" class="heading-style-h2">Structured Transcript</h2>
                    </div>
                    <div w-el="subcontent_page_richtext" id="w-node-cdfeec6a-7fff-7f3c-c124-f73a49d825af-69f85ce9" class="text-rich-text w-richtext"></div>
                  </div>
                </div>
              </div>
            </div>
    ...
    <div class="footer">
      <div class="padding-global align-center">
        <div class="footer-wrapper background-color-black">
          <a href="#" class="footer-logo w-inline-block">
            <div class="embed-logo w-embed"><svg width="100%" style="" viewbox="0 0 252 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M9.00475 1.09994H0.544746C0.444746 1.09994 0.364746 1.15994 0.364746 1.27994V2.65994C0.364746 2.75994 0.444746 2.83994 0.544746 2.83994H3.82475V13.8199C3.82475 13.9399 3.90475 13.9999 4.00475 13.9999H5.54475C5.66475 13.9999 5.72475 13.9399 5.72475 13.8199V2.83994H9.00475C9.10475 2.83994 9.18475 2.75994 9.18475 2.65994V1.27994C9.18475 1.15994 9.10475 1.09994 9.00475 1.09994Z" fill="black"></path>
                <path d="M22.9585 1.09994H21.4185C21.2985 1.09994 21.2385 1.15994 21.2385 1.27994V6.63994H15.8185V1.27994C15.8185 1.15994 15.7385 1.09994 15.6385 1.09994H14.0985C13.9785 1.09994 13.9185 1.15994 13.9185 1.27994V13.8199C13.9185 13.9399 13.9785 13.9999 14.0985 13.9999H15.6385C15.7385 13.9999 15.8185 13.9399 15.8185 13.8199V8.37994H21.2385V13.8199C21.2385 13.9399 21.2985 13.9999 21.4185 13.9999H22.9585C23.0785 13.9999 23.1385 13.9399 23.1385 13.8199V1.27994C23.1385 1.15994 23.0785 1.09994 22.9585 1.09994Z" fill="black"></path>
                <path d="M36.7262 2.83994C36.8262 2.83994 36.8862 2.75994 36.8862 2.65994V1.27994C36.8862 1.15994 36.8262 1.09994 36.7262 1.09994H29.2262C29.1062 1.09994 29.0462 1.15994 29.0462 1.27994V13.8199C29.0462 13.9399 29.1062 13.9999 29.2262 13.9999H36.7262C36.8262 13.9999 36.8862 13.9399 36.8862 13.8199V12.4399C36.8862 12.3399 36.8262 12.2599 36.7262 12.2599H30.9462V8.33994H36.1262C36.2262 8.33994 36.2862 8.25994 36.2862 8.15994V6.77994C36.2862 6.67994 36.2262 6.59994 36.1262 6.59994H30.9462V2.83994H36.7262Z" fill="black"></path>
                <path d="M207.63 13.7799L205.19 9.21994C206.81 8.87994 207.51 7.81994 207.51 5.95994V4.47994C207.51 2.17994 206.43 1.09994 203.85 1.09994H199.07C198.95 1.09994 198.89 1.15994 198.89 1.27994V13.8199C198.89 13.9399 198.95 13.9999 199.07 13.9999H200.61C200.71 13.9999 200.79 13.9399 200.79 13.8199V9.33994H203.21L205.51 13.8599C205.57 13.9799 205.63 13.9999 205.73 13.9999H207.49C207.63 13.9999 207.71 13.9199 207.63 13.7799ZM200.79 2.83994H203.43C205.27 2.83994 205.61 3.17994 205.61 4.47994V5.95994C205.61 7.25994 205.27 7.61994 203.43 7.61994H200.79V2.83994Z" fill="black"></path>
                <path d="M212.685 10.6999C212.685 13.0199 213.785 14.1599 217.365 14.1599H217.485C221.065 14.1599 222.165 13.0199 222.165 10.6999V4.39994C222.165 2.07994 221.065 0.939941 217.485 0.939941H217.365C213.785 0.939941 212.685 2.07994 212.685 4.39994V10.6999ZM214.585 10.6999V4.39994C214.585 3.13994 215.025 2.67994 217.365 2.67994H217.485C219.825 2.67994 220.265 3.13994 220.265 4.39994V10.6999C220.265 11.9599 219.825 12.4199 217.485 12.4199H217.365C215.025 12.4199 214.585 11.9599 214.585 10.6999Z" fill="black"></path>
                <path d="M227.776 10.6999C227.776 13.0199 228.876 14.1599 232.316 14.1599H232.436C235.876 14.1599 236.976 13.0199 236.976 10.6999V1.27994C236.976 1.15994 236.916 1.09994 236.796 1.09994H235.256C235.156 1.09994 235.076 1.15994 235.076 1.27994V10.6999C235.076 11.9599 234.636 12.4199 232.436 12.4199H232.316C230.116 12.4199 229.676 11.9599 229.676 10.6999V1.27994C229.676 1.15994 229.596 1.09994 229.496 1.09994H227.956C227.836 1.09994 227.776 1.15994 227.776 1.27994V10.6999Z" fill="black"></path>
                <path d="M247.789 1.09994H242.969C242.849 1.09994 242.789 1.15994 242.789 1.27994V13.8199C242.789 13.9399 242.849 13.9999 242.969 13.9999H244.509C244.609 13.9999 244.689 13.9399 244.689 13.8199V9.59994H247.789C250.309 9.59994 251.429 8.49994 251.429 6.21994V4.47994C251.429 2.19994 250.309 1.09994 247.789 1.09994ZM249.529 6.21994C249.529 7.49994 249.169 7.87994 247.329 7.87994H244.689V2.83994H247.329C249.169 2.83994 249.529 3.21994 249.529 4.47994V6.21994Z" fill="black"></path>
              </svg></div>
          </a>
        </div>
      </div>
  ...
  <script src="https://d3e54v103j8qbb.cloudfront.net/js/jquery-3.5.1.min.dc5e7f18c8.js?site=655b434272e0596d7e6126bc" type="text/javascript" integrity="sha256-9/aliU8dGd2tb6OSsuzixeV4y/faTqgFtohetphbbj0=" crossorigin="anonymous"></script>
  <script src="/assets/js/training-nvg-platform-3c3dc0a66fa7c2e1d.js" type="text/javascript"></script>
  <script>
  
    setInterval(function (){ 
window._wq = window._wq || [];
_wq.push({ id: "{{$lesson->wistia_video_id}}", onReady: function(video) {
    var per = 0;   
    ...
    $.ajax(
    {
        url: "<?php echo URL("/") ?>/update-video-time",
        type: 'post',
        dataType: "JSON",
        data: { 
            "lesson_id": "{{$lesson->id}}",
