...
<head>
  ...
  <link href="<?php echo URL("/") ?>/assets/images/favicon.png" rel="shortcut icon" type="image/x-icon">
  <link href="<?php echo URL("/") ?>/assets/images/webclip.png" rel="apple-touch-icon"><!--  [Attributes by Finsweet] CMS Nest  -->
